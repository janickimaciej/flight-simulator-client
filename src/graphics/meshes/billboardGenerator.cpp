...
namespace Graphics
{
	std::vector<Vertex> BillboardGenerator::generate(const glm::vec2& size)
	{
		...
		triangle1[0].texturePos = glm::vec2{0, 1};
		triangle1[1].pos = glm::vec3{sizeHalf.x, -sizeHalf.y, 0};
		triangle1[1].texturePos = glm::vec2{1, 1};
		triangle1[2].pos = glm::vec3{-sizeHalf.x, sizeHalf.y, 0};
		triangle1[2].texturePos = glm::vec2{0, 0};
